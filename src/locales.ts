export const uiStrings = {
  en: {
    ...
    trailingStep1Desc: "The order became ACTIVE because the price hit your Activation Price.",
    trailingStep2Desc: "After activation, the system tracked this best price point:",
    trailingStep3Desc: "Success! The price pulled back from the peak enough to trigger.",
  ...
  tr: {
    ...
    trailingStep1Desc: "Fiyat Aktivasyon Seviyesine ulaştığı için emir AKTİF hale geldi.",
    trailingStep2Desc: "Aktivasyondan sonra sistem şu en iyi fiyat noktasını takip etti:",
    trailingStep3Desc: "Başarılı! Fiyat zirveden yeterince geri çekilerek emri tetikledi.",
