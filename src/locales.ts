export const uiStrings = {
  en: {
    ...
    trailingMarkPrecisionWarning: "⚠️ Important: Mark Price history only has 1-minute resolution. Sequence within the minute is estimated (High/Low order is unknown). For exact second-level verification, use 'Last Price'.",
    trailingEstimatedNotice: "⚠️ **Estimated Result**: Activation, Peak change, or Trigger occurred within the same minute. Since Mark Price only has 1-minute data, this sequence is a 'best-case' estimate. Real execution might have been slightly later.",
  ...
  tr: {
    ...
    trailingMarkPrecisionWarning: "⚠️ Önemli: Mark Fiyatı geçmişi sadece 1 dakikalık çözünürlüğe sahiptir. Dakika içindeki saniye sıralaması tahminidir (En Yüksek/En Düşük sırası belli değildir). Kesin sonuç için 'Last Price' kullanın.",
    trailingEstimatedNotice: "⚠️ **Tahmini Sonuç**: Aktivasyon, Zirve değişimi veya Tetiklenme aynı dakika içinde gerçekleşti. Mark Fiyatı sadece dakikalık veriye sahip olduğu için bu sıralama bir 'en iyi ihtimal' tahminidir. Gerçek gerçekleşme biraz daha geç olmuş olabilir.",
